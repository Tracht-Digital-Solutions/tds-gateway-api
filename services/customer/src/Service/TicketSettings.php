...
/**
 * Reads/writes the ticket_setting key/value table — currently the three email
 * notification toggles the admin controls. Unknown keys are ignored on write so
...
final class TicketSettings
{
    ...
    public function all(): array
    {
        ...
        $stmt = $this->pdo->query('SELECT setting_key, setting_value FROM ticket_setting');
        if ($stmt !== false) {
